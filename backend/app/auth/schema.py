...
class SecurityQuestionsSchema(str, Enum):
    MOTHER_MAINDEN_NAME = "mother_maiden_name"
    ...
    def get_description(cls, value: "SecurityQuestionsSchema") -> str:
        descriptions = {
            cls.MOTHER_MAINDEN_NAME: "What is the name of your mother?",
            cls.CHILDHOOD_FRIEND: "What is the name of childhood friend?",
