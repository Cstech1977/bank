...
Revision ID: e947742fd248
Revises: 
Create Date: 2025-12-23 17:45:49.772783
...
def upgrade() -> None:
    ...
    sa.Column('security_question', sa.Enum('MOTHER_MAINDEN_NAME', 'CHILDHOOD_FRIEND', 'FAVORITE_COLOR', 'BIRTH_CITY', name='securityquestionsschema'), nullable=False),
